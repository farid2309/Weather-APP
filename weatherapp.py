...
lbl_greeting = ttk.Label(text="Please enter City, Country or Postcode", fg="white", bg="black")
lbl_greeting.grid(row=0, column=0, sticky="w")
lbl_input = ttk.Entry(bg="black", fg="white")
lbl_input.grid(row=3, column=0)
population_label = ttk.Label(text="", fg="white", bg="black")
population_label.grid(row=10, column=0)
weather_label = ttk.Label(text="", fg="white", bg="black")
weather_label.grid(row=6, column=0)
error_label = ttk.Label(text="", fg="white", bg="black")
error_label.grid(row=8, column=2)

button_submit = ttk.Button(text="Submit", fg="white", bg="black", borderwidth=0.2, command=press)
